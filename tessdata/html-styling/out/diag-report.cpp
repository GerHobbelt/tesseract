 ...
 * Source code for file 'diag-report.css', last modified 1721331987.
...
namespace bin2cpp
{
  ...
  public:
    ...
    virtual size_t getSize() const { return 3502; }
    ...
    void build()
    {
      ...
      mBuffer.append("p.error-message {\n  background-color: #fff0f0;\n  padding: 0.5em;\n  border: solid 3px red;\n  margin: 1em;\n  max-width: 96em;\n}\np.warning-message {\n  background-color: #fff9f1;\n  padding: 0.5em;\n  borde", 200);
      mBuffer.append("r: solid 2px #ff9000;\n  margin: 0.5em 1em;\n  max-width: 96em;\n}\nsection.image-display {\n\tborder:  solid 1px grey;\n    padding: 1em 2em;\n\tbackground-color: #f6f6f6;\n\tmargin: 1em;\n\tmax-width: 100em;\n}\ns", 200);
      mBuffer.append("ection.image-display h6 {\n    font-size: 1.08em;\n    margin-top:  1em;\n}\nsection.image-display p {\n}\n\n", 102);
    }
