...
DebugView::Color GetMatchColorFor(float Evidence);
...
void RenderIntProto(ScrollViewReference &window, INT_CLASS_STRUCT *Class, PROTO_ID ProtoId, DebugView::Color color);
...
void DisplayIntFeature(const INT_FEATURE_STRUCT *Feature, float Evidence) {
  DebugView::Color color = GetMatchColorFor(Evidence);
