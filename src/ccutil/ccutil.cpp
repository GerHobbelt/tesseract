...
CCUtil::CCUtil()
    ...
    , INT_INIT_MEMBER(ambigs_debug_level, 0, "Debug level for the unichar ambiguities", params())
    , INT_INIT_MEMBER(universal_ambigs_debug_level, 0, "Debug level for loading the universal unichar ambiguities", params())
