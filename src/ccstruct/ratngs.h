...
template <>
struct formatter<BlobChoiceClassifier> : formatter<string_view> {
  // parse is inherited from formatter<string_view>.

  template <typename FormatContext>
  auto format(const BlobChoiceClassifier &c, FormatContext &ctx) const {
...
template <>
struct formatter<PermuterType> : formatter<string_view> {
  // parse is inherited from formatter<string_view>.

  template <typename FormatContext>
  auto format(const PermuterType &c, FormatContext &ctx) const {
    std::string_view name = "unknown";
    switch (c) {
